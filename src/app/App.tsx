  ...
  return (
    <Router>
      <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white transition-colors duration-300">
        ...
        {/* pt-20 evita que a Navbar cubra o topo das páginas */}
        <main className="pt-20"> 
          <Routes>
            ...
            <Route path="/polos" element={<div className="py-40 text-center text-2xl font-bold">Em breve: Nossos Polos de Treino</div>} />
          </Routes>
        </main>
      </div>
    </Router>
